...
function updateColors(type: ColorType, color: Color) {
  if (type === 'primary') {
...
function applyTheme(type: ColorType, color: Color) {
  if (type === 'primary') {
      ...
      <div>
        ...
        <div class="pt-2 flex gap-2 flex-wrap justify-between">
          <button
            ...
            class="border-none w-5 h-5 rounded-full p-0 cursor-pointer outline-none outline-offset-1" :class="[{ 'outline-primary': layoutConfig.primary === primaryColor.name }]"
